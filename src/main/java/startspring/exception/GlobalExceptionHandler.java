...
import startspring.common.response.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ResponseRequestDto> handleMethodArgumentNotValidException(MethodArgumentNotValidException ex) {
        ...
        return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(new ResponseRequestDto(false));
    }
    ...
    public ResponseEntity<ResponseRequestDto> resourceNotExistException(Exception e) {
